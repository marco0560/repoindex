...
def _expand_include_graph_neighbors(
    ...
    *,
    ...
    graph_signals : list[repoindex.query.signals.RetrievalSignal] | None
    ...
    symbols_in_module : collections.abc.Callable[[pathlib.Path, str], list[repoindex.types.SymbolRow]]
