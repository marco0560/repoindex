...
class FunctionArtifact:
    ...
    calls : tuple[repoindex.models.CallSite, ...]
        Ordered call-site records owned by the function.
    callable_refs : tuple[repoindex.models.CallableReference, ...]
...
class ClassArtifact:
    ...
    has_docstring : int
        Integer flag compatible with the current SQLite schema.
    methods : tuple[repoindex.models.FunctionArtifact, ...]
...
class AnalysisResult:
    ...
    def iter_callable_references(self) -> tuple[CallableReference, ...]:
        ...
        Returns
        -------
        tuple[repoindex.models.CallableReference, ...]
