...
from repoindex.indexer import _dot_similarity, _rebuild_graph_indexes, _store_analysis
...
from repoindex.sqlite_backend_support import (
...
if TYPE_CHECKING:
    ...
    from repoindex.sqlite_backend_support import StoredEmbeddingRow
...
class SQLiteIndexBackend:
    ...
    def persist_analysis(
        ...
        *,
        ...
        previous_embeddings : dict[str, repoindex.sqlite_backend_support.StoredEmbeddingRow] | None, optional
